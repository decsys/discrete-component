...
const params = {
  ...
  radio7: ParamTypes.string("Option 8"),
  radio7Secondary: ParamTypes.string("Secondary Label 8"),
  radio7: ParamTypes.string("Option 9"),
  radio7Secondary: ParamTypes.string("Secondary Label 9"),
  radio7: ParamTypes.string("Option 10"),
  radio7Secondary: ParamTypes.string("Secondary Label 10"),
  radio7: ParamTypes.string("Option 11"),
  radio7Secondary: ParamTypes.string("Secondary Label 11"),
